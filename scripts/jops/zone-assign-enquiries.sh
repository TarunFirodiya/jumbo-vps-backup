...
# Only re-route events created after their ZoneAgent allocation changed.
# Earlier enquiry ownership remains immutable.
RECONCILE_OUTPUT=$(python3 /opt/jops/zone-agent-reconcile.py --object enquiry --live 2>&1)
RECONCILE_EXIT=$?
